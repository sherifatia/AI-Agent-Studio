"""OpenRouter provider — TODO, not yet implemented.
...
class OpenRouterProvider(BaseProvider):
    """TODO provider: OpenRouter is not implemented yet.
    ...
    def generate(self, messages: list[dict[str, str]]) -> Response:
        ...
        Raises:
            NotImplementedError: Always. OpenRouter support is planned but
                not yet built.
        """
